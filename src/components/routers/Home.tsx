...
function Home() {
  ...
  */}
      ...
      <GridItem area="main" marginLeft="70px">
        ...
        >
          <Heading>
            ¡Bienvenidos! Welcome 欢迎 Bienvenidos स्वागत مرحبًا স্বাগত
            Bem-vindos Добро пожаловать ようこそ സ്വാഗതം Willkommen Bienvenue ਜੀ
            ਆਇਆ ਨੂੰ Sugeng rawuh 欢迎 స్వాగతం स्वागत आहे Hoş geldiniz
            வரவேற்கின்றோம் خوش آمدید.
          </Heading>
          ...
          <Heading size="lg" marginTop={5} textAlign={"right"}>
            Haz scroll hacia abajo para ver mis proyectos.
          </Heading>
        </Box>
        {projectslist.map((p) => (
          <Project
        ...
        <NextPage
          nextPageLink="about"
          message="¿Curioso? Descubre más sobre mí en 'About Me'. ¡No te lo pierdas! 😄"
        />
        <div>
          <Outlet />
        </div>
