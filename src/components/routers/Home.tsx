...
const projectslist:Project[] =[
  ...
  {title:"Kiki's house", subtitle:"Este proyecto personal de React.js es la creación de una página web para un restaurante que refleja mi pasión por el diseño estético. He puesto un énfasis especial en el estilo elegante y uniforme de la plataforma. Desde la elección de la paleta de colores hasta la disposición meticulosa de cada elemento, cada detalle ha sido cuidadosamente seleccionado para garantizar una experiencia visualmente atractiva y coherente. ",imageSrc:"/kiki-s-tea-house.png", link:"https://hongyulu-github.github.io/kiki-s-house/"},
  {title:"Kiki's tea house", subtitle:" Nos complace presentar la expansión de nuestro querido proyecto Kiki's House en forma de una tienda de té en línea creada con Vite + React. En Kiki's Tea House, te invitamos a explorar una amplia variedad de tés exquisitos, desde los sabores clásicos hasta las mezclas más innovadoras. ",imageSrc:"/kiki-s-house.png", link:"https://kiki-s-tea-house.vercel.app/"},
